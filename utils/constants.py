...
phi_template = {
    "system_format": "<|system|>{content}</s>",
    "user_format": "<|user|>{content}</s><|assistant|>",
    "assistant_format": "{content}</s>",
    "tool_format": "{content}",
    "function_format": "{content}",
    "observation_format": "<|user|>{content}</s><|assistant|>",
    "system": None,
}
...
model2size = {
    ...
    # Phi model
    "microsoft/phi-3": 3_700_000_000,
    "microsoft/Phi-3-mini-4k-instruct": 3_700_000_000,
}
